...
| File Search | Duplicate Finder | Video Quality Check |
|-------------|-----------------|---------------------|
| ![File Search](docs/screenshot-file-search.png) | ![Duplicate Finder](docs/screenshot-duplicate.png) | ![Video Quality Check](docs/screenshot-video-check.png) |
